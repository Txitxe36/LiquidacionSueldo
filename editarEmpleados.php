          ...
          <form class="row g-3" method="POST" action="actualizar.php" autocomplete="off">
            <div class="col-md-4">
              <label for="ID" class="form-label">Legajo</label>
                ...
                <input type="password" id="usuario" name="usuario" class="form-control" value="<?php echo $row['usuario']; ?>" readonly>
                <label for="clave" class="form-label">Clave</label>
                <input type="password" id="clave" name="clave" class="form-control" value="<?php echo $row['clave']; ?>" readonly>
