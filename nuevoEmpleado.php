...
<body class="py-3">
    <main class="container">
      ...
      <div class="row">
        <div class="col">
          <form class="row g-3" method="POST" action="guardarEmpleado.php" autocomplete="off">
            <div class="col-md-4">
                ...
                <button type="submit" id="guardar" class="btn btn-primary" name="guardar">Guardar</button>
